...
namespace backend\modules\sysManage\components;

use Yii;
use backend\modules\sysManage\models\AuthItem;
use backend\modules\sysManage\models\searchs\AuthItem as AuthItemSearch;
