...
namespace backend\modules\sysManage\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use backend\modules\sysManage\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\backend\modules\sysManage\models\Menu]].
 *
 */
